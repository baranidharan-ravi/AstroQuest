...
Welcome to **AstroQuest**, an AI-powered cosmic learning adventure designed for young explorers (Ages 2 to 14)! This combined guide serves as both the **User Quick Start Guide** for parents and educators, and the **Contributing Guide** for open-source contributors and developers.
...
## 11. Reporting Bugs & Suggesting Features

We welcome contributions from educators, parents, and software developers to expand AstroQuest's educational impact!
...
## 12. Submitting Pull Requests (PRs)
...
## 13. Architecture & Coding Standards

- For a deep architectural breakdown of speech synthesis, live AI schemas, Web Speech Chromium recovery, and vector PDF diploma generation, consult the **[Technical Architecture Documentation (AstroQuest_Implementation_Documentation.md)](documentation/AstroQuest_Implementation_Documentation.md)**.
- All application state lives in scoped `localStorage` keys prefixed with `thinksheet_` or `astroquest_`.
- Dynamic models are cached with validation timestamps in `thinksheet_dynamic_gemini_models_v1`.

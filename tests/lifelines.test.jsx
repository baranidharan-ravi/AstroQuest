...
import { LIFELINE_TABS, CHRONO_FREEZE_SECONDS, LIFELINE_DEFINITIONS } from '../src/constants';
import { BADGE_DEFINITIONS } from '../src/utils/badgeManager';
import { playTelemetryScanSound, playChronoFreezeSound } from '../src/utils/audioSynthesis';
...
describe('Cosmic Lifelines Suite', () => {
  ...
  it('includes Telemetry Specialist and Chrono Guardian in badge definitions', () => {
    const telemetryBadge = BADGE_DEFINITIONS.find((b) => b.id === 'telemetry_master');

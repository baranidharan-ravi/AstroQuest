		...
		<div className='min-h-screen space-background flex flex-col justify-between text-white font-sans overflow-x-hidden select-none p-4 sm:p-6'>
			...
			<header className='w-full max-w-5xl mx-auto flex items-center justify-between gap-2 relative z-10'>
				...
				<button
					...
					className={`flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-purple-900/60 to-indigo-900/60 border border-purple-500/40 hover:border-purple-400 px-2 sm:px-3.5 py-1 sm:py-1.5 rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all cursor-pointer flex-shrink-0 ${
						isIntroActive ?
							'opacity-0 -translate-y-4 pointer-events-none'
						:	'opacity-100 translate-y-0'
					}`}
					title='Open Profile & Settings'>
					<div className='w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-pink-500/30 flex items-center justify-center text-[10px] sm:text-xs font-black text-pink-300 flex-shrink-0'>
						⭐
					</div>
							...
							<div className='flex flex-wrap gap-1.5'>
								{SKILLSET_PRESETS.map((preset) => (
									<button
										...
										className='px-2.5 py-1 rounded-lg bg-white/10 hover:bg-white/20 border border-white/15 text-xs font-bold text-slate-200 hover:text-cyan-200 transition-all flex items-center gap-1.5 cursor-pointer'>
						...
						<form
							...
							<div>
								...
								<input
									...
									className='w-full bg-[#090B24] border border-cyan-400/50 focus:border-cyan-400 rounded-xl px-3.5 py-2.5 text-sm text-white font-bold focus:outline-none focus:ring-2 focus:ring-cyan-400'
								/>
							</div>
							...
							<div>
								...
								<input
									...
									className='w-full bg-[#090B24] border border-white/20 focus:border-cyan-400 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none'
								/>
							</div>
							...
							<div>
								...
								<textarea
									...
									className='w-full bg-[#090B24] border border-cyan-400/50 focus:border-cyan-400 rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:ring-2 focus:ring-cyan-400 resize-none'
								/>
							</div>
							...
							<div>
								...
								<div className='flex items-center gap-2'>
									...
									<input
										...
										className='w-20 bg-[#090B24] border border-white/20 rounded-lg px-2 py-1 text-xs text-center text-white'
									/>
								</div>
							</div>
								...
								<div className='flex items-center gap-2 flex-wrap'>
									{Object.entries(COLOR_THEMES).map(([key, theme]) => (
										<button
											...
											className={`px-3 py-1.5 rounded-xl border text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${theme.chipBg} ${
												newSkillColor === key ?
							...
							<div className='flex items-center justify-end gap-3 pt-3 border-t border-white/10 mt-2'>
								...
								<button
									type='submit'
									className='px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-extrabold text-xs sm:text-sm shadow-lg hover:scale-105 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer'>
									<Sparkles className='w-4 h-4 text-amber-300' />
